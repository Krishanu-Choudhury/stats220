...
**Conclusion**: Cafes and Restaurants tend to be the most common place of transactions as observed in my data.
...
**Conclusion**: People generally prefer to use Card(Debit/Credit) for payments as observed in my data.
...
**Conclusion**: Most transactions happen during Afternoon as observed in my data.
